...
| 3.1.0  | Updated target frameworks to include .NET 6.0 and .NET 8.0. Updated packages: SSH.NET dependency from 2024.1.0 to 2024.2.0, DependencyInjection dependency from 7.0.0 to 8.0.0 and Annotations from 4.7.0 to 5.0.0. |
